...
public final class FastLogFormatter extends SimpleFormatter {
	...
	/**
	 * Line separator string. This is the value of the line.separator property at the moment that the SimpleFormatter
	 * was created.
	 */
	 ...
	 * date formatter args
	 */
	private final Object[] dateFormatterArgs = new Object[1];
