...
// @BatchSize(size=100)
@Embeddable
public class MultiStringName implements MultiString {
	...
	public MultiStringName() {
		// TODO Auto-generated constructor stub
	}

	public MultiStringName(String en, String fa) {
		super();
		setEn(en);
		setFa(fa);
	}
	...
	@Override
	public MultiStringName clone() {
		return new MultiStringName(en, fa);
	}
