...
public class ExtendedLocaleTime extends LocaleDate {
	...
	public ExtendedLocaleTime(Date d) {
        setDate(d);
	}

	public ExtendedLocaleTime(Date d, Locale locale) {
        setDate(d, locale);
	}

    public ExtendedLocaleTime(int year, byte month, byte day, Date date) {
        this.year = year;
        this.month = month;
        this.day = day;
        this.date = date;
	...
	@Override
	public ExtendedLocaleTime clone() {
		return (ExtendedLocaleTime) super.clone();
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ExtendedLocaleTime other = (ExtendedLocaleTime) obj;
		if (date == null) {
			if (other.date != null)
				return false;
