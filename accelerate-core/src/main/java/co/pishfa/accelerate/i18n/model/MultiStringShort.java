 ...
 */
@Embeddable
public class MultiStringShort implements MultiString {
	...
	public MultiStringShort() {
	}

	public MultiStringShort(String en, String fa) {
		super();
		setEn(en);
		setFa(fa);
	}

	public MultiStringShort(String key) {
	...
	@Override
	public MultiStringShort clone() {
		return new MultiStringShort(en, fa);
	}
