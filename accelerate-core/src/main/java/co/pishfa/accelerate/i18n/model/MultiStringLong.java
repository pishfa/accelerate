...
// @Embeddable
public class MultiStringLong extends BaseEntity implements MultiString {
	...
	public MultiStringLong() {
	}

	public MultiStringLong(String en, String fa) {
		super();
		this.en = en;
		this.fa = fa;
	}
	...
	@Override
	public MultiStringLong clone() {
		return new MultiStringLong(en, fa);
	}
